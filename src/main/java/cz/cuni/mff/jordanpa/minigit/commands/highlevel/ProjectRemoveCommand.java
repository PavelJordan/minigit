...
public final class ProjectRemoveCommand implements Command {
    ...
    @Override
    public String help() {
        return "Unregister repository from project manager in the current directory.";
    }

    @Override
    public String usage() {
        return "minigit project-remove <path>";
    }
    ...
    public int execute(String[] args) {
        ...
        try {
            ...
            for (String path : args) {
                IO.println("Removing " + path + "...");
                pm.removeProject( Path.of(path));
            }
            pm.save();
            IO.println("Done.");
        }
